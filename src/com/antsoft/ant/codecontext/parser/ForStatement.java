 ...
 * ForStatement.java
 * Title: °³¹Ì
 * Part : ForStatement class(tree node)
...
/**
  the non terminal ForStatement node.
 
  @author Kim, sung-hoon
 */
public class ForStatement extends TreeNode {
	/**
	  Constructor.
	  the node number : 84.
	 ...
	 */
	public ForStatement(int x,int y,int option) {
		this(x,y);
	...
	/**
	  ...
	  @param y the column number.
	 */
	public ForStatement(int x,int y) {
		super(x,y,NonTerminal.FORSTATEMENT);
	}
