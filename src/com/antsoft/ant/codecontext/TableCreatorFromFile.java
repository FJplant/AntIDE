/*
 * $Header: /AntIDE/source/ant/codecontext/TableCreatorFromFile.java 15    99-06-06 11:17p Kahn $
...
/**
  ...
  */
public class TableCreatorFromFile {
  ...
  public TableCreatorFromFile(File f) {
    ...
    FileLoader loader= new FileLoader( f, doc );
		// get the text.
		getDocumentText(doc);
			...
			if (currentElement!=null) {	// declaration : the class, interface, field, method
				...
				switch (currentElement.getMemberSort()) {
					...
					case SymbolTableEntry.FIELD:
						...
						//System.out.println("the key="+key+" the type="+currentElement.getType());
            currentElement.table=null;
            //System.out.println(" from file key = "+key);
              ...
              methodEntry = currentElement;
							...
							//System.out.println("key inside"+parser.getKey());
