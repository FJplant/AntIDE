/*
 * $Header: /usr/cvsroot/AntIDE/source/com/antsoft/ant/pool/sourcepool/NormalContext.java,v 1.2 1999/08/19 06:27:59 remember Exp $
 ...
 *  @author Jinwoo Baek
 */
public class NormalContext extends StyleContext implements ViewFactory {
  // --- ViewFactory methods -------------------------------------

  public View create(Element elem) {
    return new NormalView(elem);
  }
}
