/*
 * $Header: /usr/cvsroot/AntIDE/source/com/antsoft/ant/pool/sourcepool/JavaView.java,v 1.13 1999/08/19 06:27:59 remember Exp $
 ...
 */
public final class JavaView extends AntView {
//  private boolean syntaxColoring = true;
  ...
  public JavaView( JavaContext context, Element elem) {
    ...
    lexer = (JavaDocument.Scanner )doc.createScanner();
    lexerValid = false;
