/*
 * $Header: /usr/cvsroot/AntIDE/source/com/antsoft/ant/designer/classdesigner/CodeGenerator.java,v 1.6 1999/08/20 06:27:28 remember Exp $
...
public class CodeGenerator {
    ...
    String mod = "";
    if(generalInfo.isPublic()) mod += "public ";
    if(generalInfo.isFinal()) mod += "final ";
    if(generalInfo.isAbstract()) mod += "abstract ";
    mod = mod.trim();

		theCode.append(mod + " class "+generalInfo.getClassName()+blank);
