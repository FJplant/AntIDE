/*
 * $Header: /usr/cvsroot/AntIDE/source/com/antsoft/ant/designer/methoddesigner/DiagramItemFor.java,v 1.3 1999/07/22 02:58:38 multipia Exp $
...
class DiagramItemFor extends DiagramItem
{
  ...
  public void calcBound()
  {
    ...
    bound.incHeight(DiagramItem.UNIT_LHEIGHT * 9 + UNIT_HEIGHT * 3);
  }
}
