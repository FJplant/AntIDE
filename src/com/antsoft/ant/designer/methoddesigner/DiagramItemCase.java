/*
 * $Header: /usr/cvsroot/AntIDE/source/com/antsoft/ant/designer/methoddesigner/DiagramItemCase.java,v 1.3 1999/07/22 02:58:38 multipia Exp $
...
/**
 *
 *  case ( Method Designer )
 *
 */


class DiagramItemCase extends DiagramItem
{
  ...
  public void calcBound()
  {
    ...
    bound.incHeight(DiagramItem.UNIT_LHEIGHT * 4 + UNIT_HEIGHT);
  }
}
