/*
 * $Header: /usr/cvsroot/AntIDE/source/com/antsoft/ant/designer/codeeditor/NormalEditorKit.java,v 1.6 1999/08/23 04:57:55 remember Exp $
 ...
 */
public class NormalEditorKit extends DefaultEditorKit {
  private Hashtable actionHash = new Hashtable();

	public NormalEditorKit() {
		super();
  }

	public NormalContext getStylePreferences() {
		if (preferences == null) {
			preferences = new NormalContext();
		}
		return preferences;
	}

	public void setStylePreferences(NormalContext prefs) {
		preferences = prefs;
	}
	 ...
	 */
	public Object clone() {
		NormalEditorKit kit = new NormalEditorKit();
