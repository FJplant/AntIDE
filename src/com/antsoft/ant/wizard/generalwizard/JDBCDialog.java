/*
 * $Header: /usr/cvsroot/AntIDE/source/com/antsoft/ant/wizard/generalwizard/JDBCDialog.java,v 1.2 1999/08/19 05:25:07 multipia Exp $
 ...
 * @author YunKyung Kim
 */
public class JDBCDialog extends JDialog implements ActionListener, KeyListener {
	//EventHandler
	JDBCWizard wizard;
	//Frame
	JFrame frame;
	...
	JTextField packName = new JTextField(14);
	JTextField className = new JTextField( "JDBC1", 14 );
...
*/
   	...
   	panel3.add( hostPort );
    	...
    	panel6.setBorder( new BlackTitledBorder( "Set Protocol" ) );
    	...
    	panel7.setBorder( new BlackTitledBorder( "Authentification" ) );
