/*
 * $Id: PropertyDialog.java,v 1.2 1999/08/19 05:25:07 multipia Exp $
...
public class PropertyDialog extends JDialog implements ActionListener, KeyListener, ItemListener{
  ...
  BlackTitledBorder border1 = new BlackTitledBorder("Property");
  BlackTitledBorder border2 = new BlackTitledBorder("Method");
  ...
  public void keyReleased(KeyEvent e){
    if(!StripString.isNull(name.getText()))
      ok.setEnabled(true);
