/*
 * $Id: PanelDialog.java,v 1.2 1999/08/19 05:25:07 multipia Exp $
...
/*
 *  PanelDialog - panel을 생성하는 위저드 다이어로그
 *  designed by Kim yun Kyung
 *  date 1999.7.13
 */
public class PanelDialog extends JDialog implements ActionListener, KeyListener{
  public JTextField panelName;
  ...
  public PanelDialog(Frame parent,String title,boolean modal) {
...
//    packName.addKeyListener(this);
    ...
    JLabel panelLbl = new JLabel("Panel Name");
    panelLbl.setPreferredSize(new Dimension(100,20));
    panelName = new JTextField("Panel1",17);
    panelName.addKeyListener(this);
    p2.add(panelLbl);
    p2.add(panelName);
...
//    ok.setEnabled(false);
  ...
  public void keyReleased(KeyEvent e){
    ...
    }else*/ if(e.getSource() == panelName){
      if(!(panelName.getText().equals("")) && !(panelName.getText()==null))
        ok.setEnabled(true);
      else ok.setEnabled(false);
    }
  }
