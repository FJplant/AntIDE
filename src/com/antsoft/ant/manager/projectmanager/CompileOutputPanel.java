/*
 * $Id: CompileOutputPanel.java,v 1.2 1999/08/30 08:07:24 remember Exp $
 ...
 *  @author Jinwoo Baek
 */
public class CompileOutputPanel extends JPanel {
  ...
  private int numOfWarns  = 0;
	 ...
	 *  Constructor
	 */
  public CompileOutputPanel(ProjectExplorer pe) {
		this.pe = pe;
    try  {
      uiInit();
    }
  ...
  void uiInit() throws Exception {
    ...
    tree.setCellRenderer(new CompileOutputPanelTreeCellRenderer());
